    ...
    <section className="hero-shell">
      ...
      <div className="hero-grid">
        <div className="hero-copy">
          <p className="eyebrow">Philippines talent atlas</p>
          <h1>Outsourced Philippines: a talent atlas for clearer staffing decisions.</h1>
          <p className="lead">A redesigned outsourced Philippines staffing guide for companies hiring Philippines-based remote staff and managed teams. The page now uses a distinct organic and natural layout, industry-specific planning sections, and a conversion path that feels made for this niche.</p>
        ...
        <figure className="hero-media"><img src={site.heroImage || site.serviceImage} alt={site.alt || `${site.brand} planning visual`}/><figcaption>island map labels and soft blocks</figcaption></figure>
      </div>
    </section>
