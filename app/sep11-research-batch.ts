...
export const sep11ResearchPosts: readonly ResearchPost[] = [
  {
    slug: 'philippines-decision-register-completeness-research-2026-study',
    title: 'Can a decision register reduce lost executive follow-up?, September 11 protocol',
  ...
  {
    slug: 'philippines-catalog-exception-resolution-research-2026-study',
    title: 'Does a catalog exception queue reduce unsupported product values?, September 11 protocol',
  ...
  {
    slug: 'philippines-record-request-minimum-data-research-2026-study',
    title: 'Can a minimum-data tracker manage record requests without copying sensitive files?, September 11 protocol',
  ...
  {
    slug: 'philippines-privileged-access-expiry-research-2026-study',
    title: 'Do expiry checks reduce lingering privileged access?, September 11 protocol',
  ...
  {
    slug: 'philippines-sop-observation-triage-research-2026-study',
    title: 'Can structured observation notes improve SOP change triage?, September 11 protocol',
