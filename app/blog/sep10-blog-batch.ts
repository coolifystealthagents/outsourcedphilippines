...
const topics: readonly Topic[] = [
  {
    slug: 'philippines-executive-assistant-decision-register',
    title: 'A decision register for executive support that people will keep using',
  ...
  {
    slug: 'philippines-customer-support-escalation-receipt',
    title: 'Give every customer escalation a receipt',
  ...
  {
    slug: 'philippines-ecommerce-product-attribute-exception-queue',
    title: 'Do not let odd product attributes vanish into a spreadsheet',
  ...
  {
    slug: 'philippines-bookkeeping-vendor-statement-gap-review',
    title: 'How to review gaps in a vendor statement without making an accounting call',
  ...
  {
    slug: 'philippines-recruitment-candidate-consent-log',
    title: 'A practical consent log for recruitment coordination',
  ...
  {
    slug: 'philippines-real-estate-maintenance-access-brief',
    title: 'The maintenance access brief that protects everyone’s time',
  ...
  {
    slug: 'philippines-healthcare-admin-record-request-tracker',
    title: 'Track healthcare record requests without widening access',
  ...
  {
    slug: 'philippines-sales-operations-territory-conflict-check',
    title: 'Run a territory conflict check before assigning the lead',
  ...
  {
    slug: 'philippines-legal-admin-filing-proof-index',
    title: 'Build a filing-proof index without treating “sent” as filed',
  ...
  {
    slug: 'philippines-marketing-utm-governance-log',
    title: 'A UTM governance log for campaigns with many hands',
  ...
  {
    slug: 'philippines-it-helpdesk-privileged-request-packet',
    title: 'What belongs in a privileged-access request packet?',
  ...
  {
    slug: 'philippines-operations-sop-observation-notes',
    title: 'Write SOP observation notes before rewriting the SOP',
...
export const sep10BlogPosts = topics.map(({ slug, title, excerpt }) => ({
  slug,
  title,
  excerpt,
  minutes: 8,
...
export const sep10BlogBasics = Object.fromEntries(topics.map((topic) => [topic.slug, {
