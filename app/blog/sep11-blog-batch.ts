...
const topics: readonly Topic[] = [
  {
    slug: 'philippines-executive-assistant-decision-register-operating-guide',
    title: 'A decision register for executive support that people will keep using, September 11 edition',
  ...
  {
    slug: 'philippines-customer-support-escalation-receipt-operating-guide',
    title: 'Give every customer escalation a receipt, September 11 edition',
  ...
  {
    slug: 'philippines-ecommerce-product-attribute-exception-queue-operating-guide',
    title: 'Do not let odd product attributes vanish into a spreadsheet, September 11 edition',
  ...
  {
    slug: 'philippines-bookkeeping-vendor-statement-gap-review-operating-guide',
    title: 'How to review gaps in a vendor statement without making an accounting call, September 11 edition',
  ...
  {
    slug: 'philippines-recruitment-candidate-consent-log-operating-guide',
    title: 'A practical consent log for recruitment coordination, September 11 edition',
  ...
  {
    slug: 'philippines-real-estate-maintenance-access-brief-operating-guide',
    title: 'The maintenance access brief that protects everyone’s time, September 11 edition',
  ...
  {
    slug: 'philippines-healthcare-admin-record-request-tracker-operating-guide',
    title: 'Track healthcare record requests without widening access, September 11 edition',
  ...
  {
    slug: 'philippines-sales-operations-territory-conflict-check-operating-guide',
    title: 'Run a territory conflict check before assigning the lead, September 11 edition',
  ...
  {
    slug: 'philippines-legal-admin-filing-proof-index-operating-guide',
    title: 'Build a filing-proof index without treating “sent” as filed, September 11 edition',
  ...
  {
    slug: 'philippines-marketing-utm-governance-log-operating-guide',
    title: 'A UTM governance log for campaigns with many hands, September 11 edition',
  ...
  {
    slug: 'philippines-it-helpdesk-privileged-request-packet-operating-guide',
    title: 'What belongs in a privileged-access request packet?, September 11 edition',
  ...
  {
    slug: 'philippines-operations-sop-observation-notes-operating-guide',
    title: 'Write SOP observation notes before rewriting the SOP, September 11 edition',
...
export const sep11BlogPosts = topics.map(({ slug, title, excerpt }) => ({
  slug,
  title,
  excerpt,
  minutes: 8,
...
export const sep11BlogBasics = Object.fromEntries(topics.map((topic) => [topic.slug, {
