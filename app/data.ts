...
export const blogPosts = [...legacyBlogPosts, ...allDailyBlogPosts, ...aug31BlogPosts].sort((a, b) => {
...
export const blogBasics = { ...legacyBlogBasics, ...allDailyBlogBasics, ...aug31BlogBasics };
