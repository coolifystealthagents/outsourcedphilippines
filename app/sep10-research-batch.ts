...
export const sep10ResearchPosts: readonly ResearchPost[] = [
  {
    slug: 'philippines-decision-register-completeness-research',
    title: 'Can a decision register reduce lost executive follow-up?',
  ...
  {
    slug: 'philippines-catalog-exception-resolution-research',
    title: 'Does a catalog exception queue reduce unsupported product values?',
  ...
  {
    slug: 'philippines-record-request-minimum-data-research',
    title: 'Can a minimum-data tracker manage record requests without copying sensitive files?',
  ...
  {
    slug: 'philippines-privileged-access-expiry-research',
    title: 'Do expiry checks reduce lingering privileged access?',
  ...
  {
    slug: 'philippines-sop-observation-triage-research',
    title: 'Can structured observation notes improve SOP change triage?',
